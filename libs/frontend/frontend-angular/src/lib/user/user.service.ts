...
export class UserService
{
    ...
    public list(options?: any): Observable<TUser[] | null> {
        return this.httpService.list<TUser>(this.endpoint, options);
    }

    public read(id: string | null, options?: any): Observable<TUser> {
        return this.httpService.read<TUser>(this.endpoint, id, options);
    }

    public create(optionsCreate: TUserCreate): Observable<TUser> {
        return this.httpService.create<TUser>(this.endpoint, optionsCreate);
    }

    public update(id: string, optionsUpdate: TUserUpdate): Observable<TUser> {
        return this.httpService.update<TUser>(this.endpoint, id, optionsUpdate);
    }

    public delete(id: string) {
        return this.httpService.delete<TUser>(this.endpoint, id);
    }
}